...
/**
 * Validates and analyzes a list of asyncApiDocuments and get applications described by those files
 * 
 * @param {Array} asyncApiDocs An array of asyncApiDocuments
 * @param {Object} syntax relation diagram format
 * @returns {Promise<DiscoveredRelations>} Relations between documents in the requested syntax
 */
